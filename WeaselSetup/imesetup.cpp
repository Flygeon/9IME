...
// {1FD438C8-55B3-4A14-816F-8CF6EEEF1490}  (9IME text service)
static const GUID c_clsidTextService = {
    0x1fd438c8,
    0x55b3,
    0x4a14,
    {0x81, 0x6f, 0x8c, 0xf6, 0xee, 0xef, 0x14, 0x90}};

// {B071CE35-CD33-4B1A-BD60-C7990E855AC5}  (9IME profile)
static const GUID c_guidProfile = {
    0xb071ce35,
    0xcd33,
    0x4b1a,
    {0xbd, 0x60, 0xc7, 0x99, 0x0e, 0x85, 0x5a, 0xc5}};
...
int install(const std::wstring& profile, bool silent) {
  ...
  rootDir.pop_back();
  auto ret = SetRegKeyValue(HKEY_LOCAL_MACHINE, WEASEL_REG_KEY, L"9IMERoot",
  ...
  const WCHAR PROFILE_KEY[] = L"Software\\Rime\\9IME";
...
int uninstall(bool silent) {
  ...
  const WCHAR KEY[] = L"Software\\Rime\\9IME";
  HKEY hKey;
