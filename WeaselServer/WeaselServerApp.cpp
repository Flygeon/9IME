...
int WeaselServerApp::Run() {
  ...
  // 9IME: automatic update checking is disabled; releases are published
  // on GitHub and announced by the user. See WeaselServerApp::check_update.
  // win_sparkle_set_registry_path("Software\\Rime\\9IME\\Updates");
  // win_sparkle_init();
