...
!define WEASEL_ROOT $INSTDIR\9ime-${WEASEL_VERSION}
!define REG_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\9IME"

; The name of the installer
Name "9IME ${WEASEL_VERSION}"

; The file to write
OutFile "archives\9ime-${PRODUCT_VERSION}-installer.exe"

VIProductVersion "${WEASEL_VERSION}.${WEASEL_BUILD}"
VIAddVersionKey /LANG=2052 "ProductName" "9IME"
...
VIAddVersionKey /LANG=2052 "FileDescription" "9IME輸入法"
...
LangString DISPLAYNAME ${LANG_TRADCHINESE} "9IME輸入法"
LangString LNKFORMANUAL ${LANG_TRADCHINESE} "【9IME】說明書"
LangString LNKFORSETTING ${LANG_TRADCHINESE} "【9IME】輸入法設定"
LangString LNKFORDICT ${LANG_TRADCHINESE} "【9IME】用戶詞典管理"
LangString LNKFORSYNC ${LANG_TRADCHINESE} "【9IME】用戶資料同步"
LangString LNKFORDEPLOY ${LANG_TRADCHINESE} "【9IME】重新部署"
LangString LNKFORSERVER ${LANG_TRADCHINESE} "9IME算法服務"
LangString LNKFORUSERFOLDER ${LANG_TRADCHINESE} "【9IME】用戶文件夾"
LangString LNKFORAPPFOLDER ${LANG_TRADCHINESE} "【9IME】程序文件夾"
LangString LNKFORUPDATER ${LANG_TRADCHINESE} "【9IME】檢查新版本"
LangString LNKFORSETUP ${LANG_TRADCHINESE} "【9IME】安裝選項"
LangString LNKFORUNINSTALL ${LANG_TRADCHINESE} "卸載9IME"
LangString CONFIRMATION ${LANG_TRADCHINESE} "安裝前，請先卸載舊版本的9IME。$\n$\n按下「確定」移除舊版本，按下「取消」放棄本次安裝。"
...
LangString DISPLAYNAME ${LANG_SIMPCHINESE} "9IME输入法"
LangString LNKFORMANUAL ${LANG_SIMPCHINESE} "【9IME】说明书"
LangString LNKFORSETTING ${LANG_SIMPCHINESE} "【9IME】输入法设定"
LangString LNKFORDICT ${LANG_SIMPCHINESE} "【9IME】用户词典管理"
LangString LNKFORSYNC ${LANG_SIMPCHINESE} "【9IME】用户资料同步"
LangString LNKFORDEPLOY ${LANG_SIMPCHINESE} "【9IME】重新部署"
LangString LNKFORSERVER ${LANG_SIMPCHINESE} "9IME算法服务"
LangString LNKFORUSERFOLDER ${LANG_SIMPCHINESE} "【9IME】用户文件夹"
LangString LNKFORAPPFOLDER ${LANG_SIMPCHINESE} "【9IME】程序文件夹"
LangString LNKFORUPDATER ${LANG_SIMPCHINESE} "【9IME】检查新版本"
LangString LNKFORSETUP ${LANG_SIMPCHINESE} "【9IME】安装选项"
LangString LNKFORUNINSTALL ${LANG_SIMPCHINESE} "卸载9IME"
LangString CONFIRMATION ${LANG_SIMPCHINESE} '安装前，请先卸载旧版本的9IME。$\n$\n点击 "确定" 移除旧版本，或点击 "取消" 放弃本次安装。'
...
LangString DISPLAYNAME ${LANG_ENGLISH} "9IME"
LangString LNKFORMANUAL ${LANG_ENGLISH} "9IME Manual"
LangString LNKFORSETTING ${LANG_ENGLISH} "9IME Settings"
LangString LNKFORDICT ${LANG_ENGLISH} "9IME Dictionary Manager"
LangString LNKFORSYNC ${LANG_ENGLISH} "9IME Sync User Profile"
LangString LNKFORDEPLOY ${LANG_ENGLISH} "9IME Deploy"
LangString LNKFORSERVER ${LANG_ENGLISH} "9IME Server"
LangString LNKFORUSERFOLDER ${LANG_ENGLISH} "9IME User Folder"
LangString LNKFORAPPFOLDER ${LANG_ENGLISH} "9IME App Folder"
LangString LNKFORUPDATER ${LANG_ENGLISH} "9IME Check for Updates"
LangString LNKFORSETUP ${LANG_ENGLISH} "9IME Installation Preference"
LangString LNKFORUNINSTALL ${LANG_ENGLISH} "Uninstall 9IME"
LangString CONFIRMATION ${LANG_ENGLISH} "Before installation, please uninstall the old version of 9IME.$\n$\nPress 'OK' to remove the old version, or 'Cancel' to abort installation."
...
toquit:
  ...
  ReadRegStr $R0 HKLM "Software\Rime\9IME" "InstallDir"
  StrCmp $R0 "" 0 skip
...
skip:
  ReadRegStr $R0 HKLM \
  "Software\Microsoft\Windows\CurrentVersion\Uninstall\9IME" \
  "UninstallString"
  StrCmp $R0 "" done
...
uninst:
  ...
  ReadRegStr $R1 HKLM SOFTWARE\Rime\9IME "9IMERoot"
  StrCmp $R1 "" call_uninstaller
  IfFileExists $R1\data\*.* 0 call_uninstaller
  CreateDirectory $TEMP\9ime-backup
  CopyFiles $R1\data\*.* $TEMP\9ime-backup
...
call_uninstaller:
  ...
  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\9IME"
  ...
  ${ElseIf} ${IsNativeAMD64}
    SetRegView 64
  ${Endif}
  DeleteRegValue HKLM "Software\Microsoft\Windows\CurrentVersion\Run" "9IMEServer"
...
InstallDirRegKey HKLM "Software\Rime\9IME" "InstallDir"
...
Section "9IME"
  ...
  ; HKLM SOFTWARE\WOW6432Node\Rime\9IME "InstallDir" "$INSTDIR"
  WriteRegStr HKLM SOFTWARE\Rime\9IME "InstallDir" "$INSTDIR"
  ...
  IfFileExists $TEMP\9ime-backup\*.* 0 program_files
  CreateDirectory $INSTDIR\data
  CopyFiles $TEMP\9ime-backup\*.* $INSTDIR\data
  RMDir /r $TEMP\9ime-backup
...
program_files:
  ...
  ${Endif}
  ; Write autorun key
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Run" "9IMEServer" "$INSTDIR\WeaselServer.exe"
  ; Start WeaselServer
  ...
  WriteRegStr HKCU "Software\Rime\9IME\Updates" "CheckForUpdates" "0"
  GoTo end
  EnableAutoCheckUpdate:
  WriteRegStr HKCU "Software\Rime\9IME\Updates" "CheckForUpdates" "1"
  end:
